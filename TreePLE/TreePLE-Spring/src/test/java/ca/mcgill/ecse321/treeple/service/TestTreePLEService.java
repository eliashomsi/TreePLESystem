...
public class TestTreePLEService {
	...
	@Test
	public void testCreateResidentInvalidEmail() {
		assertEquals(0, treeSystem.getResidents().size());

		TreePLEService treeService = new TreePLEService(treeSystem);

		String name = "John";
		String email = "john.ddd@";
		String password = "1234";
		double longitude = 12.123433;
		double latitude = 43.432112;
		String type = "resident";
		...
		// Check error
		assertEquals(error, "email format is not right");
	...
	private void checkResultResident(TreePLESystem treeSystem, String aName, String aEmail, String aPassword,
